...
5. **Output** — A detailed summary is saved as an Excel file in the `results/` folder.
...
3. **Report** — A count total for each symbol per floor plan is exported to an Excel sheet.
